...
Scaffold AjaxController $ControllerName $FkName -ModelType $ModelType -DbContextType $DbContextType -Force:$Force -Area:$Area

Scaffold AjaxRazorViews $ControllerName $FkName -ModelType $ModelType -Force:$Force -Area:$Area

Scaffold Portugues.ViewModel $ControllerName -ModelType $ModelType -Area:$Area
